...
Write-Host "Actualizando EvolvAI a v1.0.4..."
...
Copy-Item (Join-Path $source 'CHANGELOG_V1_0_4.md') (Join-Path $target 'CHANGELOG_V1_0_4.md') -Force
Write-Host "Actualizacion v1.0.4 completada. La carpeta android NO se ha modificado."
