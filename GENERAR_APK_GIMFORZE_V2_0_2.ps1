...
Write-Host "   GIMFORZE v2.0.2 - CORRECCIONES" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Copy-Item (Join-Path $source 'README_V2_0_2.md') (Join-Path $target 'README_V2_0_2.md') -Force
Copy-Item (Join-Path $source 'CHANGELOG_V2_0_2.md') (Join-Path $target 'CHANGELOG_V2_0_2.md') -Force
...
Set-Location $target
Write-Host "[OK] Código v2.0.2 copiado. Android/applicationId conservados." -ForegroundColor Green
...
$desktop = Join-Path $env:USERPROFILE 'Desktop\Gimforze-v2.0.2.apk'
