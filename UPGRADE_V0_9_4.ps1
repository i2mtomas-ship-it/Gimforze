...
Write-Host 'Actualizando EvolvAI a v0.9.4...' -ForegroundColor Cyan
...
Copy-Item (Join-Path $source 'CHANGELOG_V0_9_4.md') (Join-Path $target 'CHANGELOG_V0_9_4.md') -Force
