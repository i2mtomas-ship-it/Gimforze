...
Write-Host "   GIMFORZE v2.0.3 - CORRECCIONES" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Copy-Item (Join-Path $source 'README_V2_0_3.md') (Join-Path $target 'README_V2_0_3.md') -Force
Copy-Item (Join-Path $source 'CHANGELOG_V2_0_3.md') (Join-Path $target 'CHANGELOG_V2_0_3.md') -Force
...
Set-Location $target
Write-Host "[OK] Código v2.0.3 copiado. Android/applicationId conservados." -ForegroundColor Green
...
$desktop = Join-Path $env:USERPROFILE 'Desktop\Gimforze-v2.0.3.apk'
