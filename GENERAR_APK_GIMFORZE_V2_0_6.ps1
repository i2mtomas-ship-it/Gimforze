...
Write-Host "   GIMFORZE v2.0.6 - CORRECCIONES" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Set-Location $target
Write-Host "[OK] Código v2.0.6 copiado. Android/applicationId conservados." -ForegroundColor Green
...
$desktop = Join-Path $env:USERPROFILE 'Desktop\Gimforze-v2.0.6.apk'
