...
Write-Host "   GIMFORZE v2.0.11 - CORRECCIONES DE LISTAS Y CATALOGO" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Copy-Item (Join-Path $source 'README_V2_0_9.md') (Join-Path $target 'README_V2_0_9.md') -Force
Copy-Item (Join-Path $source 'CHANGELOG_V2_0_9.md') (Join-Path $target 'CHANGELOG_V2_0_9.md') -Force
...
Set-Location $target
Write-Host "[OK] Código v2.0.11 copiado. Icono Gimforze conservado. Android/applicationId conservados." -ForegroundColor Green
...
$desktop = Join-Path $env:USERPROFILE 'Desktop\Gimforze-v2.0.11.apk'
