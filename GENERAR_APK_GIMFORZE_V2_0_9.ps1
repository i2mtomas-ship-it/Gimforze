...
Write-Host "   GIMFORZE v2.0.9 - CORRECCIONES DE LISTAS Y CATALOGO" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Set-Location $target
Write-Host "[OK] Código v2.0.9 copiado. Icono Gimforze conservado. Android/applicationId conservados." -ForegroundColor Green
...
$desktop = Join-Path $env:USERPROFILE 'Desktop\Gimforze-v2.0.9.apk'
