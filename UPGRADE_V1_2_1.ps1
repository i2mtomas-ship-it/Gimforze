...
Write-Host '   EVOLVAI v1.2.1 - CORRECCION ANDROID' -ForegroundColor Cyan
Write-Host '========================================' -ForegroundColor Cyan
Write-Host ''
...
Write-Host '[OK] Codigo v1.2.1 copiado. android se conserva.' -ForegroundColor Green
Write-Host ''
Write-Host 'Ahora entra en el proyecto base y ejecuta:' -ForegroundColor Yellow
